...
class Html2Article:
    def __init__(self, header=None, separator="\n", keep_gif=False, smallest_length=2, word_with_format=False, img_with_format=False, shortest_length=18, encoding=None, with_date=False):
        self.header = header
...
if __name__ == "__main__":
    # url = 'http://bbs.17173.com/thread-10360369-1-1.html'
    url = 'http://www.runsky.com/bbc2982010991/'
    r = requests.get(url)
    r.encoding = r.apparent_encoding
    task = Html2Article(separator='.', with_date=True)
